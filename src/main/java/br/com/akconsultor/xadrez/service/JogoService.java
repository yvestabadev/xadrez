...
public class JogoService {
	...
	public boolean[][] verificaDestino(MovimentoVerificaDto mov) {
		Jogo jogo = this.novoJogo();
	...
	public TabuleiroDto move(MovimentoDto mov) {
		Jogo jogo = this.novoJogo();
		Tabuleiro tabuleiro = jogo.getTabuleiro();
		Jogador jogadorBranco = jogo.getJogador1();
		Jogador jogadorPreto = jogo.getJogador2();
		...
		Integer linha = mov.getLinhaAtual();
